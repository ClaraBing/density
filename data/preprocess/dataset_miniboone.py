...
class MINIBOONE:
    ...
    def __init__(self):
        ...
        file = '/home/bingbin/density/datasets/miniboone/miniboone.npy'
...
if __name__ == '__main__':
  data_dir = '/home/bingbin/density/datasets/miniboone/'
  fname = 'miniboone.npy'
  fname = 'data.npy'
  train, val, test = load_data_normalised(os.path.join(data_dir, fname))
  np.save(os.path.join(data_dir, 'train_normed.npy'), train)
  np.save(os.path.join(data_dir, 'val_normed.npy'), val)
  np.save(os.path.join(data_dir, 'test_normed.npy'), test)
